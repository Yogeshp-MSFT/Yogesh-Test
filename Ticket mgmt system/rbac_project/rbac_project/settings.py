...
# Priority: DATABASE_URL (Render) > DB_HOST (Supabase) > SQLite fallback
...
elif DB_HOST and 'your-supabase-host' not in DB_HOST:
    DATABASES = {
        'default': {
...
ADMIN_EMAIL = os.getenv('ADMIN_EMAIL', 'admin@rbacsystem.io')
